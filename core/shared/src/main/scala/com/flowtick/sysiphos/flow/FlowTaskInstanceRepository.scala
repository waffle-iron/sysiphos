...
trait FlowTaskInstanceRepository {
  ...
  def createFlowTaskInstance(flowInstanceId: String, flowTaskId: String, retries: Int)(implicit repositoryContext: RepositoryContext): Future[FlowTaskInstanceDetails]
