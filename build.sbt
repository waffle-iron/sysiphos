...
lazy val akka = project.in(file("akka")).
  ...
  settings(
    ...
    libraryDependencies += "com.typesafe.akka" %% "akka-cluster" % akkaV,
    libraryDependencies += "com.typesafe.akka" %% "akka-cluster-tools" % akkaV, // for the singleton
    libraryDependencies += "com.typesafe.akka" %% "akka-cluster-metrics" % akkaV,
    ...
    libraryDependencies += "com.lightbend.akka.discovery" %% "akka-discovery-config" % "0.20.0",
